    ...
    <div class="container" style="width: 100%;">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="item_f1">
                    <a href="{{ route('about.us') }}">Sobre</a>
                    <a href="{{ route('blog') }}">Blog</a>
                    <a href="{{ route('careers') }}">Carreiras</a>
                    <a href="{{ route('press') }}">Imprensa</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="item_f1">
                    ...
                    <a href="{{ route('contact.us') }}">Contate-nos</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="item_f1">
                    <a href="terms_of_use.html">Política de direitos autorais</a>
                    <a href="{{ route('terms.of.use') }}">Termos</a>
