...
<body>
	...
	<header class="header clearfix">
		...
		<!-- <div class="container main_logo" id="logo">
			<a class="navbar-brand" href="#">
				<a href="index.html"><img src="images/influencioulogo (2).png" alt="" width="30rem" height="24rem" class="" ></a>
				<a href="index.html"><img src="images/influencioulogo (1).png" alt="" width="30rem" height="24rem" class="logo-inverse "></a>
			</a>
		  </div> -->
						...
						<a href="#" class="channel_my item">
							<div class="profile_link">
								...
								<div class="pd_content">
									...
									<span class="nm_time">2 Min atrás</span>
								</div>							
							</div>							
						</a>
						<a href="#" class="channel_my item">
							<div class="profile_link">
								...
								<div class="pd_content">
									...
									<span class="nm_time">10 Min atrás</span>
								</div>							
							</div>							
						</a>
						<a href="#" class="channel_my item">
							<div class="profile_link">
								...
								<div class="pd_content">
									...
									<span class="nm_time">25 Min atrás</span>
								</div>							
							</div>							
						</a>
						...
						<a href="#" class="channel_my item">
							<div class="profile_link">
								...
								<div class="pd_content">
									...
									<span class="nm_time">12 Min atrás</span>
								</div>							
							</div>							
						</a>
						<a href="#" class="channel_my item">
							<div class="profile_link">
								...
								<div class="pd_content">
									...
									<span class="nm_time">20 Min atrás</span>
								</div>							
							</div>							
						</a>
