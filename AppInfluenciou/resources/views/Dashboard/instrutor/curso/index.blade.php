...
@section('title', 'Edututs+ - Dashboard do aluno')

@section('navbar')
    @include('Dashboard.components.navbar-instrutor')
@endsection

@section('sidebar')
    @include('Dashboard.components.sidebar-instrutor')
@endsection
        ...
        <div class="col-md-12">
            <div class="card_dash1">
                ...
                <div class="card_dash_right1">
                    <button class="create_btn_dash" onclick="window.location.href = '{{ route('cursos.create') }}';">Create Your Course</button>
                </div>
            </div>
        </div>					
    </div>
                            ...
                            <table class="table ucp-table">
                                ...
                                <tbody>
                                    @forelse ($cursos as $item)
                                        <tr>
                                            <td>{{ $item->titulo }}</td>
                                            <td class="text-center">{{ \Carbon\Carbon::parse($item->created_at)->isoFormat('DD/MM/YYYY HH:mm:ss') }}</td>
